package fr.swapp.graphic.controls
{
	 ...
	 * @author ZoulouX
	 */
	public class SCallout extends SGraphic
	{
		/**
		 * Lorsque ce callout est touché
		 */
		protected var _onTapped							:Signal 				= new Signal(SCallout);
		...
		// TODO : Callout extends button ? Callout avec les TouchDelegate?
		/**
		 * Le constructeur
		 ...
		 */
		public function SCallout (pColor:uint = 0x888888, pAlpha:Number = .4, pBorderRadius:int = 5, pDuration:Number = .5, pAnimated:Boolean = true)
		{
			// Appliquer le fond
