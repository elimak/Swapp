package fr.swapp.core.display 
{
	...
	/**
	 * La classe principale pour les Sprites
	 * @author ZoulouX
	 */
	public class MasterSprite extends Sprite implements IMasterDisplayObject
	{
		/**
		 ...
		 * Le constructeur
		 */
		public function MasterSprite (pAutoInit:Boolean = true, pAutoDispose:Boolean = true)
		{
