package fr.swapp.graphic.components.bitmaps
{
	...
	public class BitmapRender
	{
		 ...
		 */
		public static const STRECH_RENDER_MODE			:String 							= "strechRenderMode";
		
		/**
		 * Pas de scaling appliqué (uniquement la densité)
		 */
		public static const NO_SCALE_RENDER_MODE		:String 							= "noScaleRenderMode";
		
		/**
		 * Répéter l'image (la densité sera appliquée)
		 */
		public static const REPEAT_RENDER_MODE			:String 							= "repeatRenderMode";
		
		/**
		 * Centrer l'image sans scaling
		 */
		public static const CENTER_RENDER_MODE			:String 							= "centerRenderMode";
		
		/**
		 * Scaler l'image par l'intérieur (spécifiez la couleur de fond pour voir les bordures)
		 */
		public static const INSIDE_RENDER_MODE			:String 							= "insideRenderMode";
		
		/**
		 * Scaler l'image par l'exérieur (image rognée)
		 */
		public static const OUTSIDE_RENDER_MODE			:String 							= "outsideRenderMode";
		
		/**
		 * Le composant fait la taille de l'image
		 */
		public static const AUTO_SIZE_RENDER_MODE		:String 							= "autoSizeRenderMode";
		
		/**
		 * Le composant est en mode sprite (utiliser les offsets pour afficher la bonne partie de l'image)
		 */
		public static const SPRITE_RENDER_MODE			:String 							= "spriteRenderMode";
		
		/**
		 * Le composant affichera avec un scaleNine automatique
		 */
		public static const AUTO_SCALE9_RENDER_MODE		:String								= "autoScale9RenderMode";
