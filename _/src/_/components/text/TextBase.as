package fr.swapp.graphic.components.text 
{
	...
	public class TextBase extends ResizableComponent 
	{
		 ...
		 */
		public function border (pBorder:Boolean = true, pBorderColor:Number = 0xFF0000):TextBase
		{
			// Appliquer
		 ...
		 */
		public function fontRender (pEmbedFont:Boolean, pAdvancedAntiAlias:Boolean):TextBase
		{
